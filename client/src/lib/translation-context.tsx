...
const translations: Record<Language, Record<string, string>> = {
  en: {
    ...
    "welcome-back": "Welcome back", "search-placeholder": "Search with AI — 'fintech interns in NYC', 'product managers at Google', etc.",
    "enrich-contacts": "Enrich All Contacts", "direct-matches": "Direct Matches", "indirect-opportunities": "Indirect Opportunities",
    ...
    "logout": "Logout", "intros": "Intros", "language": "Language",
  },
  fr: {
    close: "Fermer", loading: "Chargement...", search: "Rechercher", submit: "Soumettre", cancel: "Annuler",
    "welcome-back": "Bienvenue", "search-placeholder": "Recherchez avec l'IA — 'stagiaires fintech à NYC', 'chefs de produit chez Google', etc.",
    "enrich-contacts": "Enrichir tous les contacts", "direct-matches": "Correspondances directes", "indirect-opportunities": "Opportunités indirectes",
    ...
    "logout": "Déconnexion", intros: "Introductions", language: "Langue",
  },
};
